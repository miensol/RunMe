...
{
    public static class VsServiceLocator
    {
        public static void InitializePackageServiceProvider(IServiceProvider provider, Package package)
        {
            if (provider == null)
            {
        ...
        private static Package PluginPackage { get; set; }
        ...
        public static TService GetInstance<TService>() where TService : class
        {
            ...
            if (typeof (Package) == typeof (TService))
            {
                return PluginPackage as TService;
            }
